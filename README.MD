...
>- se positionne, pour chaque partition de ce topic, sur le dernier *offset* commité,
...
>- y ajoute un header nommé *outobx_id*, dont la valeur est égale au champ *id*,
>- relaye ce message dans le topic Kafka.
